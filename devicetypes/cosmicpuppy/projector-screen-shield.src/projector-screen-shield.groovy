metadata {
	...
	tiles {
		...
		valueTile("blankValueTile", "device.switch", width: 1, height: 1, canChangeBackground: true, decoration: flat) {
		}
...
def parse(String description) {
    ...
    switch (value) {
        ...
        case "enable":
        evt_onoff = createEvent(name: "screen", value: "enabled", displayed: true, isStateChange: true)
        break;
